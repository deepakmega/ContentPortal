...
var ViewPager = React.createClass({
  ...
  movePage(step) {
    ...
    Animated.spring(this.state.scrollValue, {toValue: scrollStep, friction: 15, tension: 200})
      .start((event) => {
        if (event.finished) {
  ...
  getCurrentPageData(){
    ...
    var pageID = dataSource.pageIdentities[this.state.currentPage];
    return dataSource.getPageData(pageID);
  },
